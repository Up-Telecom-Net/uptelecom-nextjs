...
export const metadata: Metadata = {
  ...
  description:
    "Internet fibra óptica de alta velocidade em Florianópolis com planos residenciais de 600MB e 700MB, empresariais de 400MB e 600MB e plano gamer com ExitLag. Wi-Fi em comodato, suporte local e internet ilimitada para os bairros Itacurubi, Agronômica, Monte Serrat, Trindade, Caeira, Saco dos Limões, Centro, Serrinha, Carvoeira, Pantanal, Monte Verde e Saco Grande.",
